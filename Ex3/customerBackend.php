<?php
	...
	echo '<table border = "1" style = "width = 100%">';
		echo "<tr>";
			...
			echo '<td class = "header"><strong> Quantity</strong> </td>';
			echo'<td class = "header"><strong> Cost Per Item</strong></td>';
			echo '<td class = "header"><strong>Subtotal</strong></td>';
		echo "</tr>";
		echo "<tr>";
			echo '<td class = "header"><strong>Apple</strong></td>';
			echo "<td> $q1 </td>";
			echo "<td> $2.00 </td>";
			echo "<td> $$totalApple </td>";
		echo "</tr>";
		echo "<tr>";
			echo '<td class = "header"><strong>Banana</strong></td>';
			echo "<td> $q2 </td>";
			echo "<td> $3.00 </td>";
			echo "<td>$$totalBanana </td>";
		echo "</tr>";
		echo "<tr>";
			echo '<td class = "header"><strong>Pear</strong></td>';
			echo "<td> $q3 </td>";
			echo "<td> $7.00 </td>";
			echo "<td> $$totalPear </td>";
		echo "</tr>";
		echo "<tr>";
			echo '<td class = "header"> <strong>Shipping</strong> </td>';
			echo "<td colspan='2'> $typeShipping </td>";
			echo "<td> $$totalShipping </td>";
		echo "</tr>";
		echo "<tr>";
			echo '<td colspan="3" class="header"> <strong>Total Cost</strong> </td>';
			echo "<td> $$total </td>";
		echo "</tr>";
	echo "</table>";
?>